...
function ChatGPT(props) {
  ...
  const handleChatGPT = async () => {
    ...
    const messages = [
      ...
      {
        role: "user",
        content: "학생의 문의사항 <" + summary + ">에 대한 답변을 생성해줘. <" + keywords + "> 내용을 토대로 답변을 생성해줘. 답변의 앞뒤에 친절한 인삿말과 끝맺음말을 추가해줘. 원래 내가 쓴 답변을 다시 출력해줄 필요는 없어. 마지막으로 <" + summary + ">에 해당하는 내용이 무엇인지 정리해서 '문의 주신 내용은 다음과 같습니다. 1. 2. ...' 형식으로 먼저 소개해주고, 그 뒤에 질문에 대한 답변을 작성해줘.",
      },
    ];
